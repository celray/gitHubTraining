      ...
      ch_dep%sed = sd_ch(ich)%wash_bed_fr * ht1%sed
      ch_dep%orgn = sd_ch(ich)%n_dep_enr * sd_ch(ich)%wash_bed_fr * ht1%orgn
      ch_dep%sedp = sd_ch(ich)%p_dep_enr * sd_ch(ich)%wash_bed_fr * ht1%sedp
      ht1 = ht1 - ch_dep
